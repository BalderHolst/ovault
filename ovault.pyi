...
class Token:
    ...
    @final
    class Code(Token):
        __match_args__: Final = ("span", "lang", "code", "ticks")
        def __new__(cls, /, span: Span, lang: str |None, code: str, ticks: int) -> Token.Code: ...
        @property
        def code(self, /) -> str: ...
        @property
    ...
    class ExternalLink(Token):
        ...
        def span(self, /) -> Span: ...
    @final
    class FootnoteDef(Token):
        __match_args__: Final = ("span", "label", "tokens")
        def __new__(cls, /, span: Span, label: str, tokens: Sequence[Token]) -> Token.FootnoteDef: ...
        @property
        def label(self, /) -> str: ...
        @property
        def span(self, /) -> Span: ...
        ...
        def tokens(self, /) -> list[Token]: ...
    @final
    class FootnoteRef(Token):
        __match_args__: Final = ("span", "label")
        def __new__(cls, /, span: Span, label: str) -> Token.FootnoteRef: ...
        @property
        def label(self, /) -> str: ...
        @property
        def span(self, /) -> Span: ...
    ...
    class InlineCode(Token):
        ...
        def span(self, /) -> Span: ...
    @final
    class InlineFootnote(Token):
        __match_args__: Final = ("span", "tokens")
        def __new__(cls, /, span: Span, tokens: Sequence[Token]) -> Token.InlineFootnote: ...
        @property
        def span(self, /) -> Span: ...
        @property
        def tokens(self, /) -> list[Token]: ...
