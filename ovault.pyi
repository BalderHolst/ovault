...
class Token:
    ...
    class FootnoteDef(Token):
        __match_args__: Final = ("span", "name", "tokens")
        def __new__(cls, /, span: Span, name: str, tokens: Sequence[Token]) -> Token.FootnoteDef: ...
        @property
        def name(self, /) -> str: ...
        @property
        def span(self, /) -> Span: ...
    ...
    class FootnoteRef(Token):
        __match_args__: Final = ("span", "name")
        def __new__(cls, /, span: Span, name: str) -> Token.FootnoteRef: ...
        @property
        def name(self, /) -> str: ...
        @property
        def span(self, /) -> Span: ...
